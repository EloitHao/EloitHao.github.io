...
Please read [this link](https://EloitHao.github.io/jekyll/Jekyll-Build.html#what-should-i-modify). 

I **strongly** recommand that you use the other [repo](https://github.com/EloitHao/PointingToTheMoon) I specially prepared for you! It has all the features that this webiste has and has no personal information of me. You can fork that repo or leave a star if you like. 
